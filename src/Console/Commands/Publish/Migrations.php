...
class Migrations extends CanvasCommand
{
     ...
     * @var string
     */
    protected $signature = 'canvas:publish:migrations {--y|y : Skip question?} {--f|force : Overwrite any existing files.}';
     ...
     * @var string
     */
    protected $description = 'Publish Canvas migrations.';
    ...
    public function handle()
    {
        ...
        if (! $publish) {
            $publish = $this->confirm('Publish Canvas migrations?');
        }
