...
<p>
    Assigning a tag to a specific blog post is easy. Just go to the <a href="{!! route('admin.post.index') !!}">Posts</a> page and click the <span class="zmdi zmdi-edit text-primary"></span> action
...
<p>
    To delete a tag, go to the <a href="{!! route('admin.tag.index') !!}">Tags</a> page and click the <span class="zmdi zmdi-edit text-primary"></span> action on a specific tag.
