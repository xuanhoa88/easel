...
<p>
    ...
    menu item in the sidebar, and then clicking <a href="{{ url('admin/post/create') }}">Add New</a>. If you get interrupted and want to save your work for later, just toggle the
