...
<p>
    ...
    menu item in the sidebar, and then clicking <a href="{!! route('admin.post.create') !!}">Add New</a>. If you get interrupted and want to save your work for later, just toggle the
...
<p>
    To delete a post, go to the <a href="{!! route('admin.post.index') !!}">Posts</a> page and click the <span class="zmdi zmdi-edit text-primary"></span> action on a specific post.
