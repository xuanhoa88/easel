            ...
            <div class="container">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h2>Tags&nbsp;
                            <a href="{!! route('canvas.admin.tag.create') !!}"><i class="zmdi zmdi-plus-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Create a new tag"></i></a>
