<aside id="sidebar" class="sidebar c-overflow">
    ...
    <ul class="main-menu main-ul">
        ...
        <li class="sub-menu @if (Route::is('admin.post.index') || Route::is('admin.post.create') || Route::is('admin.post.edit'))active toggled @endif">
            ...
            <ul>
                <li><a href="{!! route('admin.post.index') !!}" @if (Route::is('admin.post.index') || Route::is('admin.post.edit')) class="active" @endif>All Posts <span class="label label-default label-totals">{!! Canvas\Models\Post::count() !!}</span></a></li>
        ...
        <li class="sub-menu @if (Route::is('admin.tag.index') || Route::is('admin.tag.create') || Route::is('admin.tag.edit'))active toggled @endif">
            ...
            <ul>
                <li><a href="{!! route('admin.tag.index') !!}" @if (Route::is('admin.tag.index') || Route::is('admin.tag.edit')) class="active" @endif>All Tags <span class="label label-default label-totals">{!! Canvas\Models\Tag::count() !!}</span></a></li>
        ...
        @if(\Canvas\Models\User::isAdmin(Auth::user()->role))
            <li class="sub-menu @if (Route::is('admin.user.index') || Route::is('admin.user.create') || Route::is('admin.user.edit'))active toggled @endif">
                ...
                <ul>
                    <li><a href="{!! route('admin.user.index') !!}" @if (Route::is('admin.user.index') || Route::is('admin.user.edit')) class="active" @endif>All Users <span class="label label-default label-totals">{!! Canvas\Models\User::count() !!}</span></a></li>
