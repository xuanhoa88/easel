    ...
    <div class="card-header">
        ...
        <ul class="getting-started">
            ...
            <li>
                ...
                @else
                    <i class="zmdi zmdi-globe-alt"></i> <a href="{!! route('admin.tools') !!}"><span class="label label-warning">Status: {!! strtoupper('Maintenance Mode') !!}</span></a>
                @endif
            </li>
            <li>
                @if(isset($data['disqus']) && strlen($data['disqus']))
                    <i class="zmdi zmdi-disqus"></i> <a href="{!! route('admin.settings') !!}"><span class="label label-success">Disqus: {!! strtoupper('Enabled') !!}</span></a>
                @else
                    <i class="zmdi zmdi-disqus"></i> <a href="{!! route('admin.settings') !!}"><span class="label label-danger">Disqus: {!! strtoupper('Disabled') !!}</span></a>
                @endif
            </li>
            <li>
                @if(isset($data['analytics']) && strlen($data['analytics']))
                    <i class="zmdi zmdi-trending-up"></i> <a href="{!! route('admin.settings') !!}"><span class="label label-success">Google Analytics: {!! strtoupper('Enabled') !!}</span></a>
                @else
                    <i class="zmdi zmdi-trending-up"></i> <a href="{!! route('admin.settings') !!}"><span class="label label-danger">Google Analytics: {!! strtoupper('Disabled') !!}</span></a>
                @endif
            </li>
        </ul>
    </div>
